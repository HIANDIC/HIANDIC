<h1 align="center">Hi , I'm <a>Halil</a> <br></p> Welcome to My GitHub Page</h1>
...
| Name          |                                                                                                            Description                                                                                                             |
| ------------- | :--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: |
| Linux         |                                              [Backing up, security issues, user and password management, and some string manipulation](https://github.com/HIANDIC/Linux-Project.git)                                               |
...
| Project - 505 |                      [Microservices Project with 8 microservices using Terraform, Ansible, Docker, K8s, Jenkins, Nexus, Prometheus, Grafana, Rancher ](https://github.com/HIANDIC/microservices-project.git)                       |
